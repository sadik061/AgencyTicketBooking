                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables">
                            ...
                            <?php include('../Apis/get_Main_Data_Table.php');  ?>
                            </tbody>
                        </table>
                        <!-- /.table-responsive -->
                    </div>
...
<script>
    ...
    function deleteRow(t,id) {
        ...
        var pnr=x[2].innerHTML;
        var r = confirm("Are You Sure To Delete Data with PNR = "+pnr +" ?");
        if (r == true) {
            $.ajax({
                type: 'POST',
                url: '../Apis/Delete_Main_Data.php',
                data: {
                    id:id
                },
                ...
                success: function(response) {
                    // alert(response);
                    alert("Successfully Deleted Main Data")
